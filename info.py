...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7045947967').split()] # Replace with the actual admin ID(s) to add
...
# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1002799537836")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://Database123:Database123@cluster0.qk46lwc.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")  # MongoDB URI for the second database (if MULTIPLE_DB is True)
# ============================
# Movie Notification & Update Settings
# ============================
MOVIE_UPDATE_NOTIFICATION = bool(environ.get('MOVIE_UPDATE_NOTIFICATION', True))  # Notification On (True) / Off (False)
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002488086781'))  # Notification of sent to your channel
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002638205239')) #Verification Channel Id 
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002666589163')) #If Anyone Set Your Bot In Any Group And Set Shortner In That Group Then In This Channel The All Details Come
VERIFY_IMG = environ.get("VERIFY_IMG", "https://telegra.ph/file/9ecc5d6e4df5b83424896.jpg")

TUTORIAL = environ.get("TUTORIAL", "https://t.me/how_to_downlod_7")   # Tutorial link for verification
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/how_to_downlod_7")   # Second tutorial link for verification
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/how_to_downlod_7")   # Third tutorial link for verification

# Verification (Must Fill All Veriables. Else You Got Error
SHORTENER_API = environ.get("SHORTENER_API", "21ec6d4dcdd7c0b00077994d7e87fcefc24511d5") # Shortener API key
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "flylinks.ct.ws") # Shortener website

SHORTENER_API2 = environ.get("SHORTENER_API2", "21ec6d4dcdd7c0b00077994d7e87fcefc24511d5")  # Shortener API key for second website
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "flylinks.ct.ws") # Shortener website for second website

SHORTENER_API3 = environ.get("SHORTENER_API3", "21ec6d4dcdd7c0b00077994d7e87fcefc24511d5")  
SHORTENER_WEBSITE3 = environ.get("SHORTENER_WEBSITE3", "flylinks.ct.ws") # Shortener website for third website
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/sdmoviespointes') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/moviesbazaarsupp') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/moviesbazaarsupp') # Update channel link for the bot
...
URL = "https://brave-lilyan-nitish7-614d2364.koyeb.app/".format(FQDN) if ON_HEROKU or NO_PORT else "https://{}/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://brave-lilyan-nitish7-614d2364.koyeb.app/".format(FQDN)
else:
    URL = "http://brave-lilyan-nitish7-614d2364.koyeb.app/".format(FQDN)
